...
namespace Core.Sms
{
    public class SmsService : ISmsService
    {
        ...
        public SmsService(EmailDbContext dbContext, IConfiguration config, HttpClient httpClient)
        {
        ...
        public async Task<string> SendSmsAsync(string from, string to, string message)
        {
            ...
            Kavenegar.Core.Models.SendResult result = await api.Send(from, to, message);
        ...
        public async Task<string> SendSmsAsync(List<String> from, List<string> to, List<string> messages)
        {
            ...
            List<Kavenegar.Core.Models.SendResult> result = new List<Kavenegar.Core.Models.SendResult>();
        ...
        public async Task<List<Kavenegar.Core.Models.SendResult>> SendBulkSmsAsync(string from, List<string> to, string message)
        {
            Kavenegar.KavenegarApi api = new Kavenegar.KavenegarApi(_apiKey);
            List<Kavenegar.Core.Models.SendResult> result = await api.Send(from, to, message);
