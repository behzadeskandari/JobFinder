...
namespace Persistance.Migrations
{
    ...
    public partial class mig001 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "personalityTestInterpretations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_personalityTestInterpretations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_personalityTestInterpretations_PersonalityTestResults_PersonalityTestResultId",
                        column: x => x.PersonalityTestResultId,
                        principalTable: "PersonalityTestResults",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_personalityTestInterpretations_PsychologyTestResults_PsychologyTestResultId",
                        column: x => x.PsychologyTestResultId,
                        principalTable: "PsychologyTestResults",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_personalityTestInterpretations_PsychologyTests_PsychologyTestId",
                        column: x => x.PsychologyTestId,
                        principalTable: "PsychologyTests",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_personalityTestInterpretations_PersonalityTestResultId",
                table: "personalityTestInterpretations",
                column: "PersonalityTestResultId");

            migrationBuilder.CreateIndex(
                name: "IX_personalityTestInterpretations_PsychologyTestId",
                table: "personalityTestInterpretations",
                column: "PsychologyTestId");

            migrationBuilder.CreateIndex(
                name: "IX_personalityTestInterpretations_PsychologyTestResultId",
                table: "personalityTestInterpretations",
