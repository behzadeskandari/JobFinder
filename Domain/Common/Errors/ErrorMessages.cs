...
namespace JobFinder.Domain.Common.Errors
{
    ...
    public static partial class SuccessMessages
    {
        ...
        public static string RefreshToken = "Refresh Token Created";
        ...
        public static string RegisterSuccess = "Register Successfull";

        public static string ChecKLogin = "ChecK Login Successfull";
    }
